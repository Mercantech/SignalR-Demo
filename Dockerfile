...
# Build and publish the entire Aspire application
WORKDIR "/src/Demo.AppHost"
RUN dotnet publish "Demo.AppHost.csproj" -c Release -o /app/publish --no-restore
...
# Copy the published Aspire application
